...
import { Aif, Bonds } from "@linklab-test-p/common";

const AifAccount = ({ accounts }) => {
  const account: Bonds = accounts;
          ...
          <AccordionPanel borderTop="1px" borderColor="primary">
            <StatGroup w="100%">
              ...
              <Stat size="sm">
                ...
                <StatNumber>
                  {account.account.summary.holdings.holding.issuerName}
                </StatNumber>
              </Stat>
              <Stat size="sm">
                <StatLabel>coupan rate</StatLabel>
                <StatNumber>
                  {account.account.summary.holdings.holding.couponRate}
                </StatNumber>
              </Stat>
              <Stat size="sm">
                <StatLabel>coupan payment date</StatLabel>
                <StatNumber>
                  {account.account.summary.holdings.holding.coupanPaymentDate}
                </StatNumber>
              </Stat>
              <Stat size="sm">
